...
function displayCategories() {
    ...
    if (theDropdown.value === "") {
        ...
        resultsParagraph.innerHTML = `You selected the ${selectedCategories.type}`
    }
}
    ...
    function initDropdown() {
        ...
        //set value of a the option to an empty string
        defaultOption.value = "";

        //add this default option the the select box
        ...
        for (let i = 0; i < numberOfCategories; i++) {
            ...
            newOption.textContent = categories[i].type
